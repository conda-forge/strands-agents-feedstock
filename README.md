About strands-agents-feedstock
==============================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/strands-agents-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/strands-agents-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add strands-agents
# for installing globally
pixi global install strands-agents
```
...
It is possible to list all of the versions of `strands-agents` available on your platform:
...
```
pixi search strands-agents --channel conda-forge
```
